...
function calculatePrice(item) {
    ...
    if (sizeEl) {
        let text = sizeEl.nextElementSibling.textContent;
    ...
    if (milkEl) {
        let text = milkEl.nextElementSibling.textContent;
...
function addToCart(btn) {
    ...
    if (item.type === "coffee") {
        ...
        milk = document.querySelector('input[name="milk"]:checked')?.nextElementSibling.textContent.trim() || "";
        sugar = document.querySelector('input[name="sugar"]:checked')?.nextElementSibling.textContent.trim() || "";

        document.querySelectorAll('#extras-section input:checked').forEach(e => {
            extras.push(e.nextElementSibling.textContent.trim());
        });
    }
        ...
        document.querySelectorAll('#pizza-section input:checked').forEach(e => {
            toppings.push(e.nextElementSibling.textContent.trim());
        });
    }
